    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="{{asset('backend/images/icon/itcs-logo-white.png')}}" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data Komputer</h4>
                                <div class="data-tables datatable-dark">
                                  ...
                                  ?>
                                    <table id="dataTable3" class="text-center">
                                      <button type="button" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Add Data</button>
                                        ...
                                        <tbody>
                                            <tr>
                                              <td>{{$no++}}</td>
                                              <td>{{$k->kode_fa}}</td>
                                              <td>{{$k->p_merk}} {{$k->p_jenis}} Core {{$k->p_tipe}}</td>
                                              <td>{{$k->m_merk}} {{$k->m_tipe}}</td>
                                              <td>{{$k->r_kapasitas}} GB {{$k->r_tipe}} {{$k->r_slot}} Channel </td>
                                              <td>
                                                <a href="/komputer/Detail/{{ $k->id }}" class="badge badge-info">Detail</a>
                                                <a href="/komputer/Hapus/{{ $k->id }}" class="badge badge-danger">Hapus</a>
                                              </td>
                                            </tr>
                                        </tbody>
                                    </table>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2020. All right reserved. Template by <a href="https://pttrimitra.com.com/">IT TCH</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
